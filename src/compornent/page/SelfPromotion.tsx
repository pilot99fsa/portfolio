        ...
        >
          ...
          >
            <Box display={"block"}>
              ...
              <Text textAlign={"left"}>
                　私は、以前より自分の今後の事を考えて転職を考えるようになり、その中で自分の適性などを模索した結果、IT業界のWEB系の仕事に就きたいとを思いました。
                <br />
                しかし、年齢が20代後半であること、さらに未経験の業界および職種ということで実務に関するスキルがないため、WEBデザインのスクールに半年以上通い
                IllustratorとPhotoshopの使い方と基礎的なデザインの手法、さらにHTMLとCSSとJavaScript、JQueryによるWEBサイトの作成方法について学びました。
                <br />
